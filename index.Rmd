...
ent = "Q46"
year = 2019
qd2<-corpus_subset(qd,str_count(regs,ent)>0 & substr(date,1,4)==year) 
...
hc_reg <- hypercube(qd = qd,
                     ...
                     where1 = "regs",
                     where2 = "regs")
eliminate<-c("Q828", "Q12824780", "Q27394")
...
names(tab3)<-c(paste("Yeni Savas","Region",sep="_"),paste("Yeni Savas","pct",sep=" "))
